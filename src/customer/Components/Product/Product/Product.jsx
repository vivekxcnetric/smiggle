...
export default function Product() {
  ...
  useEffect(() => {
    receiveProducts().then((data) => {
      ...
      // console.log("this  is useEffect data", data?.data?.products?.edges);
    });
  }, []);
  ...
  const handleCategories = (handle) => {
    getProductsByCategory(handle).then((data) => {
      setProducts(data?.data.collection.products.edges);
      setSearchProducts(data?.data.collection.products.edges);
    });
  };
                        ...
                        <>
                          <h3 className="-my-3 flow-root">
                            ...
                            <span
                              ...
                              onClick={() => {
                                handleCategories(section.node.handle);
                              }}
                            >
                              {section.node.title}
                            </span>
